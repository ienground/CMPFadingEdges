...
import zone.ien.cmpfadingedges.example.theme.openSans
import zone.ien.cmpfadingedges.example.theme.spaceGrotesk
                    ...
                    modifier = Modifier
                        ...
                        .marqueeHorizontalFadingEdges(isMarqueeAutoLayout = false) {
                            Modifier
                                ...
                                .basicMarquee(
                                    initialDelayMillis = initialDelay.toInt(),
...
fun MainScreenContent() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        SecondaryTabRow(
            ...
            tabs = {
                SampleContentType.entries.forEach { enumValue ->
                    Tab(
        ...
        Column(
            ...
            SecondaryTabRow(
                ...
                modifier = Modifier.fillMaxWidth(),
                tabs = {
                    FadingEdgesGravity.entries.forEach { enumValue ->
                        Tab(
            ...
            if (sampleContentType != SampleContentType.Static) {
                ...
                SecondaryTabRow(
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    tabs = {
                        SampleScrollConfig.entries.forEach { enumValue ->
                            Tab(
                ...
                SecondaryTabRow(
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    tabs = {
                        SampleAnimationType.entries.forEach { enumValue ->
                            Tab(
            ...
            SecondaryTabRow(
                ...
                modifier = Modifier.fillMaxWidth(),
                tabs = {
                    SampleFillType.entries.forEach { enumValue ->
                        Tab(
    ...
    if (isColorPickerVisible) {
        ModalBottomSheet(
            ...
            KolorPicker(
                initialColor = fadingEdgesColor,
                onColorSelected = { fadingEdgesColor = it },
                modifier = Modifier
                    .fillMaxWidth()
